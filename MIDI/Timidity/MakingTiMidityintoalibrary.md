...
Timidity, either from a package manager or from the [TiMidity++](http://timidity.sourceforge.net/) web site.
...
I've based my code on [An ffmpeg and SDL Tutorial](http://dranger.com/ffmpeg/) by Stephen Dranger which uses the SDL toolkit for display.
